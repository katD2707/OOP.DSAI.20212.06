...
public class HelpTextController {
	...
	public void initialize() {
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader("src/dsai/piano/model/help.txt"));
    ...
    public void showHelp() throws IOException {
    	final String HELP_FXML_FILE_PATH = "/dsai/piano/screen/fxmlSupporter/Help.fxml";
		...
		primaryStage.getIcons().add(new Image("file:src/dsai/piano/screen/picture/icons8-question-mark-30.png"));
